...
hl.bind("SUPER + Grave", hl.dsp.exec_cmd("foot"))
hl.bind("SUPER + R", hl.dsp.exec_cmd("fuzzel"))
hl.bind("SUPER + E", hl.dsp.exec_cmd("foot yazi"))

---- FUNCTIONS
hl.bind("Print", hl.dsp.exec_cmd("hyprshot --freeze --mode region --output-folder ~/Pictures/Screenshots"))
...
-- bind = SUPER SHIFT, mouse_up, movefocus, l
-- bind = SUPER SHIFT, mouse_down, movefocus, r 
